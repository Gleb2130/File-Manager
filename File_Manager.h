...
public:
    ...
    void rename_file_folder(const string& old_name_path, const string& new_name);
    void create_folder(const string& folderName);
    void create_file(const string& filename);
    void navigate_up();
    void navigate_down(const string& folderName);
    void refresh_menu();

    void open_folder(const string& folderPath);
    void delete_folder(const string& folderPath);
